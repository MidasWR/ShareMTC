...
type Config struct {
	...
	HostAgentKafkaTopic      string
	HostAgentKafkaGroup      string
}
...
func Load() Config {
	return Config{
		...
		HostAgentKafkaTopic:      env("HOSTAGENT_KAFKA_TOPIC", "host.metrics"),
		HostAgentKafkaGroup:      env("HOSTAGENT_KAFKA_GROUP", "resourceservice-hostagent"),
	}
}
